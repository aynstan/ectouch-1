...
$_LANG['new_area'] = '新建出场区域';
$_LANG['label_country'] = '国家：';
$_LANG['label_province'] = '省份：';
$_LANG['label_city'] = '城市：';
$_LANG['label_district'] = '区/县：';

$_LANG['delete_selected'] = '移除选定的出场区域';
$_LANG['btn_add_region'] = '添加选定地区';
$_LANG['free_money'] = '免费额度:';
$_LANG['pay_fee'] = '货到付款支付费用：';
$_LANG['edit_area'] = '编辑出场区域';

$_LANG['add_continue'] = '继续添加出场区域';
$_LANG['back_list'] = '返回列表页';
$_LANG['empty_regions'] = '当前区域下没有任何关联地区';

/* 提示信息 */
$_LANG['repeat_area_name'] = '已经存在一个同名的出场区域。';
$_LANG['not_find_plugin'] = '没有找到指定的出场方式的插件。';
$_LANG['remove_confirm'] = '您确定要删除选定的出场区域吗？';
$_LANG['remove_success'] = '指定的出场区域已经删除成功！';
$_LANG['no_shippings'] = '没有找到任何可用的配送方式。';
$_LANG['add_area_success'] = '添加出场区域成功。';
$_LANG['edit_area_success'] = '编辑出场区域成功。';
$_LANG['disable_shipping_success'] = '指定的配送方式已经从该配送区域中移除。';

/* 需要用到的JS语言项 */
$_LANG['js_languages']['no_area_name'] = '出场区域名称不能为空。';
$_LANG['js_languages']['del_shipping_area'] = '请先删除该出场区域，然后重新添加。';
$_LANG['js_languages']['invalid_free_mondy'] = '免费额度不能为空且必须是一个整数。';
$_LANG['js_languages']['blank_shipping_area'] = '出场区域的所辖区域不能为空。';
