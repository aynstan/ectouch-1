  ...
  <div class="flow-checkout">
    <form action="<?php echo url('flow/done');?>" method="post" name="theForm" id="theForm" onSubmit="return checkOrderForm(this)">
      ...
      <section class="ect-margin-tb ect-padding-lr checkout-select" id="accordion"> 
        ...
        <p><b><?php echo $this->_var['lang']['shipping_method']; ?></b><span class="label ect-bg-colory">必选</span></p>
...
?>
        ...
        <p><b> <?php echo $this->_var['lang']['use_surplus']; ?> </b>(<?php echo empty($this->_var['your_surplus']) ? '0' : $this->_var['your_surplus']; ?>元)</p>
        <i class="fa fa-angle-down"></i> </a>
        <div id="collapseFour1" class="panel-collapse collapse in"> 可在<b> 用户中心-我的钱包</b>中进行充值<br />
        ...
        <p><b> <?php echo $this->_var['lang']['use_integral']; ?><?php echo $this->_var['points_name']; ?></b>(<?php echo empty($this->_var['your_integral']) ? '0' : $this->_var['your_integral']; ?> <?php echo $this->_var['points_name']; ?>)</p>
        <i class="fa fa-angle-down"></i> </a>
        <div id="collapseFive1" class="panel-collapse collapse in"> <?php echo $this->_var['lang']['noworder_can_integral']; ?><?php echo $this->_var['order_max_integral']; ?>  <?php echo $this->_var['points_name']; ?>.【100<?php echo $this->_var['points_name']; ?>=<?php echo $this->_var['integral_scale']; ?>元】<br />
        ...
        <div id="collapseFive" class="panel-collapse collapse in">
          <input name="postscript" type="text" class="fuyan" placeholder="<?php echo $this->_var['lang']['please_order_postscript']; ?>">
        </div>
      </section>
