...
<?php if ($this->_var['brand']): ?>
    <li class="brand-status" id="<?php echo $this->_var['brand']['info']; ?>">
        <?php echo $this->_var['brand']['info']; ?>
    </li>
    <?php $_from = $this->_var['brand']['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'li');if (count($_from)):
    foreach ($_from AS $this->_var['li']):
?>
    <li>
      <p><a href="<?php echo $this->_var['li']['url']; ?>"><img src="<?php echo $this->_var['li']['brand_logo']; ?>"></a><?php echo $this->_var['li']['brand_name']; ?></p>
    </li>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <?php endif; ?>
...
<dl>
  ...
  <dd><span class="pull-left"><strong><b class="ect-colory"><?php echo $this->_var['exchange']['exchange_integral']; ?>云币</b></strong><small class="ect-margin-lr"><del><?php echo $this->_var['exchange']['market_price']; ?></del></small></span> </dd>
