...
<div class="ect-padding-tb text-right" id="ECS_ORDERTOTAL">
  ...
  - <?php echo $this->_var['lang']['use_integral']; ?><?php echo $this->_var['points_name']; ?>:
  ...
  <b>=<?php echo $this->_var['lang']['total_fee']; ?>:</b> <b class="ect-colory"><?php echo $this->_var['total']['amount_formated']; ?></b><br />
