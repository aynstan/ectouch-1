<div class="filter-btn dis-box">
	<a href="mqqwpa://im/chat?chat_type=wpa&uin=<?php echo $this->_var['qq']['0']; ?>&version=1&src_type=web&web_src=qiuyun.ren" class="filter-btn-kefu filter-btn-a"><i class="iconfont icon-kefu"></i><em>客服</em></a>
