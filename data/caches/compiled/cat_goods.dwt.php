...
?>
				<li <?php if (($this->_foreach['vo']['iteration'] - 1) == 0): ?> class="active"<?php endif; ?> rel="<?php echo $this->_var['vo']['cat_id']; ?>"><?php echo $this->_var['vo']['cat_name']; ?><?php if ($this->_var['vo']['use_price']): ?></br><?php echo $this->_var['vo']['category_price']; ?>/次<?php endif; ?></li>
